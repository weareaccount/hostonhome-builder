...
const SectionComponent = ({
  ...
  const handleDomainChange = (domainId: string, value: string) => {
    ...
    console.log('🔍 DEBUG DOMAIN_NAME - Cambio dominio:', {
      ...
      sectionId: section.id,
      sectionProps,
      onSectionUpdate: typeof onSectionUpdate
    });
    ...
    console.log('🔍 DEBUG DOMAIN_NAME - Props aggiornate:', updatedProps);

    if (typeof onSectionUpdate === 'function') {
      onSectionUpdate(section.id, updatedProps);
      console.log('✅ onSectionUpdate chiamato con successo');
    } else {
    ...
    setTimeout(() => {
      ...
      if (typeof onSectionUpdate === 'function') {
        ...
        console.error('❌ onSectionUpdate non disponibile per salvataggio forzato');
      }
    }, 1000);
  };
